...
// Reads all Vite environment variables in one place.
// ─────────────────────────────────────────────
...
export const env = {
  ...
  shippingFeeStandard: toNumber(
    import.meta.env.VITE_SHIPPING_FEE_STANDARD,
    200
  ),

  shippingFreeThreshold: toNumber(
    import.meta.env.VITE_SHIPPING_FREE_THRESHOLD,
    5000
  ),
};
